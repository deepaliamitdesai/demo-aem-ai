...
var CustomImportScript = (() => {
  ...
  function parse(element, { document: document2 }) {
    ...
    const occupation = titles.length > 1 ? titles[1] : null;
    ...
    sections: [
      {
        id: "sec1",
        name: "Page title",
        selector: [".title:not(.cmp-title--underline) .cmp-title", "main > .cmp-container > .aem-Grid > .title:nth-of-type(1)"],
        style: null,
        blocks: [],
      ...
      },
      {
        ...
        selector: [".cmp-title--underline", "main .cmp-title--underline:nth-of-type(2)"],
        style: null,
        blocks: ["cards-contributor"],
        defaultContent: [".cmp-title--underline .cmp-title__text", ".text.cmp-text--font-small"]
      },
      {
        id: "sec3",
        name: "WKND Guides",
        selector: ["main .cmp-title--underline:nth-of-type(4)"],
        style: null,
        blocks: ["cards-contributor"],
        defaultContent: [".cmp-title--underline .cmp-title__text"]
      }
    ]
  };
  var parsers = {
  ...
  var import_about_us_default = {
    transform: (payload) => {
      ...
      const rawPath = new URL(params.originalURL).pathname.replace(/\/$/, "").replace(/\.html?$/, "").replace(/^\/us\/en\/about-us$/, "/about-us");
